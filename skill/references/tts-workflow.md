...
```python
scene_duration = max(audio_duration + 2.0, 6.0)
```

Never trim generated audio to fit a scene. Extend the scene or shorten text and regenerate.
...
| Scenes feel slow | Too many words per scene | Reduce text and regenerate |
